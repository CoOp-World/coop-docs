...
backend. If their user was created with a Session Order that includes [LLM Config](LLMConfig.md) (originally uploaded as
a YAML file), it is included in the user data and loaded as well as. The client holds this configuration in memory to
...
documentation](/docs/Backend/Functions/generate-decision-explanation.md))_
